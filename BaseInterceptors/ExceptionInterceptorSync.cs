...
namespace BaseInterceptors
{
    ...
    /// OnException() is implemented as synchronous, regardless of the intercepted method.
    ...
    /// </summary>
    public abstract class ExceptionInterceptorSync : IInterceptor
    {
        ...
        private async Task<TResult> InterceptAsync<TResult>(Task<TResult> task, IInvocation invocation)
        {
            ...
            catch (Exception ex)
            {
                ...
                return (TResult)OnException(invocation, ex);
            }
        }
